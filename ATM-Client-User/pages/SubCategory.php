                    ...
                    <div class="col-md-8">
						<div class="panel panel-flat">
															...
															<div class="row">
																...
																<select data-placeholder="Select Category" name="catego" id="catego" class="select-search" required="required">
																	...
																	<optgroup label="Available Categories">
																		<?php
																			$sql = "SELECT * FROM atm_categories ORDER BY category_id ASC;";
							...
							<table class="table datatable-responsive datatable-button-html5-basic">
								...
								<tbody>
									<?php
										$sql = "SELECT * FROM atm_categories, atm_sub_categories WHERE category_id=category_id_fk ORDER BY category_id DESC;";
										$stmt = $object->connect()->prepare($sql);
										$stmt->execute();
										if($stmt->rowCount())
										{
