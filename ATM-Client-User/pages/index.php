		...
		<div class="page-content">
			<div class="content-wrapper">
				<div class="panel panel-flat">
					...
					<!-- <div class="container-fluid"> $_SESSION['clientID'] -->
						<div class="row">
							<div class="col-lg-4">
								<ul class="list-inline text-center">
									...
									<li class="text-left">
										...
										<?php
											$status = 'New';
											$sqle = "SELECT COUNT(call_id) AS yanew FROM atm_calls WHERE call_status=? AND client_id_fk=?;";
											$stmte = $object->connect()->prepare($sqle);
											$stmte->bindvalue(1,$status);
											$stmte->bindvalue(2,$_SESSION['clientID']);
											if($stmte->execute())
											{
											...
											<table class="table datatable-responsive datatable-button-html5-basic" style ='font-size: 11px'>
												...
												<tbody>
													...
													//AND client_id=logged_by
														$sql = "SELECT * FROM atm_calls f,clients,atm_details, client_users WHERE client_id=f.client_id_fk AND atm_id=atm_id_fk AND client_user_id = logged_by AND f.client_id_fk=? ORDER BY call_id DESC LIMIT 10;";
