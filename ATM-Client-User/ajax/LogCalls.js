...
$("#gencall").click(function (e) {
  ...
  if (
    ...
    $.trim($("#sub_cat").val()) === "" ||
    $.trim($("#fault").val()) === "" ||
    $.trim($("#manager_name").val()) === "" ||
    $.trim($("manager_cell").val()) === null ||
    $.trim($("requester").val()) === null
  ) {
    iziToast.show({
      title: "Warning!",
...
$("#delivery_call").click(function (e) {
  ...
  if (
    $.trim($("#delivery_priority").val()) === "" ||
    $.trim($("#mech_id").val()) === "" ||
    $.trim($("#delivery_cate").val()) === "" ||
    $.trim($("#delivery_sub_cat").val()) === "" ||
    $.trim($("#item").val()) === "" ||
    $.trim($("#delivery_manager_name").val()) === "" ||
    $.trim($("delivery_manager_cell").val()) === null ||
    $.trim($("delivery_requester").val()) === null
  ) {
    iziToast.show({
      title: "Warning!",
      message: "All Fields With A * Are Required.",
