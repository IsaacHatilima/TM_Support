...
$('#save').click(function(e){
    $("#repair_device").valid();
    if ($.trim($("#devtype").val()) === "" || $.trim($("#device_serial").val()) === "" || $.trim($("#warranty").val()) === "" || $.trim($("#fault").val()) === "" || $.trim($("#gen_prob").val()) === "" || $.trim($("#parts_used").val()) === "" || $.trim($("#eos_reload").val()) === "" || $.trim($("#repaire_date").val()) === "" || $.trim($("#final_test").val()) === ""  || $.trim($("#comment").val()) === "" || $.trim($("#ptid").val()) === "" ) {
        iziToast.show({
            title: 'Warning!',
