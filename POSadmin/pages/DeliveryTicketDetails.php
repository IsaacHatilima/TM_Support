...
<body class="navbar-bottom navbar-top">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" id="general_call" action="" method="POST">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                <label class="col-md-4 control-label text-right">Item To Deliver: </label>
                                                <div class="col-md-8">
                                        ...
                                        <div class="col-md-8" id="solu" style="display:none">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea rows="3" cols="5" name="solution" id="solution"  class="form-control" placeholder="Solution"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
	...
	<script src="../ajax/AcceptDelivery.js"></script>
    <script>
