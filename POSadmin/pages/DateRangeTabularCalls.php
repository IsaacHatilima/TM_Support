							...
							<div id="accordion-control-group2" class="panel-collapse collapse">
								<div class="panel-body">
									<div class="row">
										<div class="col-md-6">
											<div class="row">
                                                <label class="col-md-4 control-label text-right">Start Date: </label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" data-mask="9999-99-99" placeholder="Enter starting date" required="required">
										...
										<div class="col-md-6">
											<div class="row">
                                                <label class="col-md-4 control-label text-right">End Date: </label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" data-mask="9999-99-99" placeholder="Enter starting date" required="required">
		                        	                <span class="help-block">9999-99-99</span>
                                                </div>
