...
<body class="navbar-bottom navbar-top">
                                                ...
                                                <div class="panel-body">
                                                    <form class="form-horizontal" id="general_call" action="" method="POST">
                                                        <div class="form-group">
                                                            <div class="col-md-8">
                                                                <div class="row">
                                                                    <label class="col-md-4 control-label text-right">Ticket Number:<span class="text-danger">*</span> </label>
                                                                    <div class="col-md-8">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                    <select data-placeholder="Select Category" name="cate" id="cate" class="select-search" required="required" onchange="getSubCates(event)">
                                                                        <option></option>
                                                        ...
                                                        <div class="text-right">
                                                            <button type="button" id='edit_ticket' class="btn btn-primary">Save <i class="icon-floppy-disk position-left"></i></button>
                                                        </div>
                                                    </form>
                                                </div>
	...
	<script src="../ajax/EditTicket.js"></script>
</body>
</html>
