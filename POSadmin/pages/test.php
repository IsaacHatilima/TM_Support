							...
							<div class="row">
								...
								<div class="col-md-2">
									...
									<ul class="menu-list">
										...
										<li><a href="sidebar_categories.html">Sidebar categories</a></li>
								...
								<div class="col-md-2">
									...
									<ul class="menu-list">
										...
										<li class="active"><a href="navigation_horizontal_hover.html">Submenu on hover</a></li>
	...
	<div class="page-header">
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li><a href="navigation_horizontal_hover.html">Horizontal nav</a></li>
				<li class="active">On hover</li>
			</ul>
		...
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Horizontal Nav</span> - On Hover</h4>
			</div>
			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Submenu on hover</h5>
						<div class="heading-elements">
							<ul class="icons-list">
					...
					<div class="panel-body">
						<div class="content-group">
							<p class="content-group">By default dropdown menu opens on <code>click</code>. Optionally it can be changed to <code>hover</code> by adding <code>data-hover="dropdown"</code> data attribute to the parent link, right there where your <code>data-toggle="dropdown"</code> is, no Javascript needed. Also include path to <code>hover_dropdown.min.js</code> file. This plugin doesn't remove click functionality, but adds an ability to open all submenu levels on hover.</p>

							<p class="text-semibold">Example navigation</p>
							<div class="navbar navbar-inverse bg-indigo bg-indigo-400 navbar-component" style="position: relative; z-index: 30;">
								<div class="navbar-header">
									<a class="navbar-brand" href="index.html"><img src="assets/images/logo_light.png" alt=""></a>
							...
							<pre class="language-markup" data-line="6"><code>&lt;!-- Left aligned navigation -->
&lt;ul class="nav navbar-nav">
				...
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						<div class="content-group-lg">
							Horizontal navigation - type of navigation that is used in the top/bottom navbars and has horizontal direction: left to right or right to left in RTL version. By default horizontal navigation is a part of <code>navbar</code> component and can include a simple link, link with icon and dropdown menu. Navigation can be placed in main navbar or in secondary navbar. Can be used in all layouts: with sidebar, 3 columns, double and dual sidebars, bottom navbar, fixed navbar etc. Default placement is main navbar. Horizontal navigation supports options:
						</div>
