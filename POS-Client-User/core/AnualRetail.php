<?php
    if(isset($_GET['year']))
    {
        ...
        // Provincial Stats
        // Central
        $sqlclo = "SELECT COUNT(ticket_number) AS central FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'Central';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        ...
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS cent FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'Central';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
        ...
        // Copperbelt
        $sqlclo = "SELECT COUNT(ticket_number) AS cb FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'Copperbelt';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        $stmtclo->bindvalue(1,$client_id);
        $stmtclo->bindvalue(2,$year);
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS copala FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'Copperbelt';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
            $stmtclo1->bindvalue(1,$client_id);
            $stmtclo1->bindvalue(2,$year);
            $stmtclo1->execute();
        ...
        // Copperbelt
        $sqlclo = "SELECT COUNT(ticket_number) AS east FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'Eastern';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        $stmtclo->bindvalue(1,$client_id);
        $stmtclo->bindvalue(2,$year);
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS eas FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'Eastern';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
            $stmtclo1->bindvalue(1,$client_id);
            $stmtclo1->bindvalue(2,$year);
            $stmtclo1->execute();
        ...
        // Luapula
        $sqlclo = "SELECT COUNT(ticket_number) AS lua FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'Luapula';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        $stmtclo->bindvalue(1,$client_id);
        $stmtclo->bindvalue(2,$year);
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS luap FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'Luapula';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
            $stmtclo1->bindvalue(1,$client_id);
            $stmtclo1->bindvalue(2,$year);
            $stmtclo1->execute();
        ...
        // Lusaka
        $sqlclo = "SELECT COUNT(ticket_number) AS lsk FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'Lusaka';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        $stmtclo->bindvalue(1,$client_id);
        $stmtclo->bindvalue(2,$year);
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS lusa FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'Lusaka';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
            $stmtclo1->bindvalue(1,$client_id);
            $stmtclo1->bindvalue(2,$year);
            $stmtclo1->execute();
        ...
        // Muchinga
        $sqlclo = "SELECT COUNT(ticket_number) AS much FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'Muchinga';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        $stmtclo->bindvalue(1,$client_id);
        $stmtclo->bindvalue(2,$year);
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS muchi FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'Muchinga';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
            $stmtclo1->bindvalue(1,$client_id);
            $stmtclo1->bindvalue(2,$year);
            $stmtclo1->execute();
        ...
        // Northern
        $sqlclo = "SELECT COUNT(ticket_number) AS north FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'Northern';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        $stmtclo->bindvalue(1,$client_id);
        $stmtclo->bindvalue(2,$year);
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS northern FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'Northern';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
            $stmtclo1->bindvalue(1,$client_id);
            $stmtclo1->bindvalue(2,$year);
            $stmtclo1->execute();
        ...
        // North-Westen
        $sqlclo = "SELECT COUNT(ticket_number) AS northwest FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'North-Westen';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        $stmtclo->bindvalue(1,$client_id);
        $stmtclo->bindvalue(2,$year);
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS northernwes FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'North-Westen';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
            $stmtclo1->bindvalue(1,$client_id);
            $stmtclo1->bindvalue(2,$year);
            $stmtclo1->execute();
        ...
        // Southern
        $sqlclo = "SELECT COUNT(ticket_number) AS south FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'Southern';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        $stmtclo->bindvalue(1,$client_id);
        $stmtclo->bindvalue(2,$year);
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS southern FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'Southern';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
            $stmtclo1->bindvalue(1,$client_id);
            $stmtclo1->bindvalue(2,$year);
            $stmtclo1->execute();
        ...
        // Western
        $sqlclo = "SELECT COUNT(ticket_number) AS west FROM pos_device_calls,mechants WHERE mechant_log_id=devcall_mechant_log_id_fk AND clientID = ? AND call_year = ?  AND mecha_type = 'Retail' AND mechant_province = 'Western';";
        $stmtclo = $object->connect()->prepare($sqlclo);
        $stmtclo->bindvalue(1,$client_id);
        $stmtclo->bindvalue(2,$year);
        if($stmtclo->execute())
        {
            ...
            $sqlclo1 = "SELECT COUNT(ticket_number) AS western FROM pos_delivery_calls,mechants WHERE mechant_log_id=delivery_mechant_log_id_fk AND clientID = ? AND delivery_call_year = ?  AND mech_type = 'Retail' AND mechant_province = 'Western';";
            $stmtclo1 = $object->connect()->prepare($sqlclo1);
            $stmtclo1->bindvalue(1,$client_id);
            $stmtclo1->bindvalue(2,$year);
            $stmtclo1->execute();
