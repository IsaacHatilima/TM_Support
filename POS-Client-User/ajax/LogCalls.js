...
$('#gencall').click(function(e){
    $("#general_call").valid();
    if ($.trim($("#priority").val()) === "" || $.trim($("#mechtype").val()) === "" || $.trim($("#dev_serial").val()) === "" || $.trim($("#cate").val()) === "" || $.trim($("#sub_cat").val()) === "" || $.trim($("#fault").val()) === "" || $.trim($("#manager_name").val()) === "" || $.trim($("manager_cell").val()) === null) {
        iziToast.show({
            title: 'Warning!',
...
$('#delivery_call').click(function(e){
    ...
    if ($.trim($("#delivery_priority").val()) === "" || $.trim($("#mech_id").val()) === "" || $.trim($("#delivery_cate").val()) === "" || $.trim($("#delivery_sub_cat").val()) === "" || $.trim($("#item").val()) === "" || $.trim($("#delivery_manager_name").val()) === "" || $.trim($("delivery_manager_cell").val()) === null ) {
        iziToast.show({
            title: 'Warning!',
            message: 'All Fields With A * Are Required.',
            color: 'yellow',
